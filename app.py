...
class EmailSpoofer:
    def __init__(self, smtp_server, smtp_port, username, password, debug_level=0):
        ...
        try:
            timeout = float(os.environ.get('SMTP_TIMEOUT_SECONDS', '8'))
        except Exception:
            timeout = 8.0
        self.smtp_timeout = max(3.0, min(30.0, timeout))
...
def _get_request_payload():
    # Accept JSON for Safari/serverless compatibility; fallback to multipart form.
